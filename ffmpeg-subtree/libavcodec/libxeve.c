...
static const AVOption libxeve_options[] = {
    ...
    { "aq-mode", "Adaptive Quantization method", OFFSET(aq_mode), AV_OPT_TYPE_INT, { .i64 = 0 }, 0, 1, VE, "aq-mode"},
    { "cu-tree", "Enable cutree for Adaptive Quantization", OFFSET(cutree), AV_OPT_TYPE_INT, { .i64 = 0 }, 0, 1, VE, "cu-tree"},
